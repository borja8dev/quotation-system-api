...
public class OpenPdfAdapter implements PdfGenerationPort {
    ...
    private void addHeader(Document doc, QuotationResponse q) throws DocumentException {
        Font titleFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 26, PRIMARY_BLUE);
        Font subtitleFont = FontFactory.getFont(FontFactory.HELVETICA, 12, PRIMARY_BLUE);
        ...
        Paragraph brand = new Paragraph("QUOTATION", titleFont);
        ...
        meta.add(new Chunk("PRESUPUESTO\n",
                FontFactory.getFont(FontFactory.HELVETICA_BOLD, 13, PRIMARY_BLUE)));
        ...
        line.setBorderColorBottom(PRIMARY_BLUE);
    ...
    private void addClientSection(Document doc, QuotationResponse q) throws DocumentException {
        Font sectionFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10, PRIMARY_BLUE);
        Font labelFont = FontFactory.getFont(FontFactory.HELVETICA, 9, Color.DARK_GRAY);
    ...
    private void addLinesTable(Document doc, List<QuotationLineResponse> lines) throws DocumentException {
        Font headerFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 9, PRIMARY_BLUE);
    ...
    private void addTotalsSection(Document doc, QuotationResponse q) throws DocumentException {
        ...
        totalLabel.setBackgroundColor(PRIMARY_BLUE);
        totalLabel.setBorderColor(PRIMARY_BLUE);
        ...
        totalValue.setBackgroundColor(PRIMARY_BLUE);
        totalValue.setBorderColor(PRIMARY_BLUE);
    ...
    private void addFooter(Document doc, QuotationResponse q) throws DocumentException {
        ...
        footer.add(new Chunk("Generated quotation document", footerFont));
        doc.add(footer);
    }
